...
class LightningModel(pl.LightningModule):
    def __init__(self, hparams):
        ...
        self.convLSTM = ConvLSTM(1, 5, kernel_size=(5, 5), num_layers=3,
                                 return_all_layers=False)
        self.linear = nn.Conv2d(in_channels=5,
                                out_channels=1,
                                kernel_size=(1, 1),
                                bias=False)
    ...
    def add_model_specific_args(parser):
        ...
        parser.add_argument("--train_batch_size", default=4, type=int, help="Training batch size")
